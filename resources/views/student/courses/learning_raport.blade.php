                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="flex items-center">
                                <div class="flex gap-[10px] items-center">
                                    ...
                                    <p class="font-semibold">{{ $correctAnswerCount }} of {{ $totalQuestions }} correct</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                            ...
                            @if ($answer->answer == 'correct')
                                <div class="flex items-center gap-[14px]">
                                    <p class="bg-[#1cff37] rounded-full p-[8px_20px] text-white font-semibold text-sm">{{ $answer->answer }}</p>
                                </div>
                            @else
                                <div class="flex items-center gap-[14px]">
