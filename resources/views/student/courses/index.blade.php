                    ...
                    @forelse ($my_courses as $course)
                        <div class="list-items flex flex-nowrap justify-between pr-10">
                            <div class="flex shrink-0 w-[300px]">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col gap-[2px]">
                                        ...
                                        <p class="text-[#7F8190]">{{ $course->category->name}}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex shrink-0 w-[120px] items-center">
                                ...
                                @else
                                    <a href="{{ route('dashboard.learning.raport.course', $course) }}" class="w-full h-[41px] p-[10px_20px] bg-[#34ff2a] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Result</a>
                                @endif
                            </div>
                        </div>
                    @empty
