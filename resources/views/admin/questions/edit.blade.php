    ...
    <body class="font-poppins text-[#0A090B]">
        <section id="content" class="flex">
            ...
            <div id="menu-content" class="flex flex-col w-full pb-[30px]">
                ...
                <form action="{{ route('dashboard.course_questions.update', $courseQuestion) }}" method="POST" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            ...
                            <input type="text" value="{{ $courseQuestion->question }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write the question" name="question">
                        </div>
                    </div>
                    {{-- <div class="flex flex-col gap-[10px]">
